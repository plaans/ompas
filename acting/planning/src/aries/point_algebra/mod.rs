use crate::aries::point_algebra::problem::{Graph, Timepoint};
use crate::aries::point_algebra::relation_type::RelationType;
use crate::aries::point_algebra::relation_type::RelationType::Tautology;
