...
(begin \
    ...
    (def-task task_navigate_to ((:params ?r ?x ?y) (:preconditions true)))
    (def-method m_task_navigate_to ((:task task_navigate_to)(:params ?r ?x ?y)(:body (rae-do (navigate_to ?r ?x ?y)))))
)";
