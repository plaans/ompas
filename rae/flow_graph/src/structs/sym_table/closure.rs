...
pub(crate) fn in_union_update(id: DomainId, union_atom: DomainId) -> UpdateClosure {
...
pub(crate) fn union_update(id: DomainId, union: Vec<DomainId>) -> UpdateClosure {
    Rc::new(Box::new(move |st| {
        let id = st.get_domain_parent(&id);
...
pub(crate) fn in_composed_update(id: DomainId, composed: DomainId) -> UpdateClosure {
    Rc::new(Box::new(move |st| {
        let id = st.get_domain_parent(&id);
...
pub(crate) fn composed_update(id: DomainId, atom: DomainId) -> UpdateClosure {
    Rc::new(Box::new(move |st| {
        let id = st.get_domain_parent(&id);
...
pub(crate) fn result_is_err_update(id: DomainId, arg_err: DomainId) -> UpdateClosure {
    Rc::new(Box::new(move |st| {
        let id = st.get_domain_parent(&id);
...
pub(crate) fn arg_is_err_update(id: DomainId, result_err: DomainId) -> UpdateClosure {
    Rc::new(Box::new(move |st| {
        let id = st.get_domain_parent(&id);
