...
pub mod primitives {
    pub const MOD_PRIMITIVES: &str = "primitives";
    pub const DOC_MOD_PRIMITIVES: &str = "Collection of primitives of the language";
...
pub mod utils {
    ...
    pub const DOC_SUB_LIST_VERBOSE: &str = "Example: (sublist '(1 2 3 4 5) 1 3) => (2 3 4)";
    ...
    pub const MACRO_CADADDR: &str =
        "(defmacro cadaddr (lambda (x) `(car (cdr (car (cdr (cdr ,x)))))))";
...
pub mod predicates {
    pub const MOD_PREDICATES: &str = "predicates";
    pub const DOC_MOD_PREDICATES: &str = "Collection of functions manipulating the kind of LValue.";
